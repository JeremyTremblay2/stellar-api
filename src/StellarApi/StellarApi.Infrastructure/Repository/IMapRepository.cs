...
public interface IMapRepository
{
    ...
    /// <summary>
    /// Retrieves the total number of public maps.
    /// </summary>
    /// <returns>A task that represents the asynchronous operation and returns the total number of public maps.</returns>
