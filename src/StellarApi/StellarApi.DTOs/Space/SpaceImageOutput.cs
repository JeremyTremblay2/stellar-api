...
namespace StellarApi.DTOs.Space
{
    ...
    public class SpaceImageOutput
    {
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="SpaceImageOutput"/> class with specified properties.
        /// </summary>
        ...
        public SpaceImageOutput(int id, string title, string description, string image, DateTime shootingDate)
        {
            Id = id;
            Title = title;
